...
Questions _$QuestionsFromJson(Map<String, dynamic> json) => Questions(
      ...
      subject: json['subject'] == null
          ? null
          : QuestionsSubject.fromJson(json['subject'] as Map<String, dynamic>),
      exam: json['exam'] == null
          ? null
          : QuestionsExam.fromJson(json['exam'] as Map<String, dynamic>),
...
QuestionsSubject _$QuestionsSubjectFromJson(Map<String, dynamic> json) =>
    QuestionsSubject(
      Id: json['_id'] as String?,
...
Map<String, dynamic> _$QuestionsSubjectToJson(QuestionsSubject instance) =>
    <String, dynamic>{
      '_id': instance.Id,
      'name': instance.name,
      'icon': instance.icon,
...
QuestionsExam _$QuestionsExamFromJson(Map<String, dynamic> json) =>
    QuestionsExam(
      Id: json['_id'] as String?,
...
Map<String, dynamic> _$QuestionsExamToJson(QuestionsExam instance) =>
    <String, dynamic>{
      '_id': instance.Id,
