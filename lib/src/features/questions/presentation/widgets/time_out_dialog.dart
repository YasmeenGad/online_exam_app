     ...
     contentPadding: const EdgeInsets.symmetric(horizontal: 10, vertical: (5)),
      ...
      content: Row(
        ...
        children: [
          ...
          SizedBox(width: 10,),
          Text("Time out !!",style:AppStyles.styleRegular24(context).copyWith(color: AppColors.errorColor),),
        
      ]),
      actions: [
        InkWell(
          onTap: () {
            Navigator.pushReplacementNamed(context, RoutesName.examScoreView,arguments: questionsArguments(
            correctScore: '10',
              incorrectScore: '10',
              totalScore: '50',
              examId: examId,
